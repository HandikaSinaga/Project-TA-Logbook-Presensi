    ...
    async up(queryInterface, Sequelize) {
        ...
        try {
            ...
            if (leaveIndexes.length === 0) {
                ...
                console.log(
                    "[Migration] ✅ Added index: idx_leaves_user_dates",
                );
            } else {
                console.log(
            ...
            if (leaveStatusIndexes.length === 0) {
                ...
                console.log(
                    "[Migration] ✅ Added index: idx_leaves_user_status",
                );
            } else {
                console.log(
            ...
            if (holidayIndexes.length === 0) {
                ...
                console.log(
                    "[Migration] ✅ Added index: idx_holidays_date_active",
                );
            } else {
                console.log(
